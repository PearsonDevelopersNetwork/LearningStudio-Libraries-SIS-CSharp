...
{
    /// <summary>
    /// This class holds the RemoveCourseCallNumbersRequest properties
    /// </summary>
    public class RemoveCourseCallNumbersRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets the DestinationCourseId property
        /// </summary>
        public string DestinationCourseId
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Gets or Sets the RemoveCourseCallNumbers property
        /// </summary>
        public string[] RemoveCourseCallNumbers
        {
            get;
            set;
        }
